                        ...
                        <div class="panel-body">
                            <div class="adv-table editable-table ">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    foreach ($arrVenta  as $list){
                                        ?>
                                        <tr>

                                            <td><?php echo $list->getFecha(); ?></td>
                                            <td><?php echo $list->getConsecutivo(); ?></td>

                                            <?php

                                            $id = $list->getClientes();
                                            $a = ClienteController::buscarID($id);
                                            $nombre = $a->getNombre();
                                            ?>
                                            <td><?php echo $nombre ?></td>
                                            <td>
                                                <a href="editarVenta.php?id=<?php echo $list->getIdVenta(); ?>" type="button" data-toggle="tooltip" title="Actualizar" class="btn docs-tooltip btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                                                <a href="listDetalleId.php?id=<?php echo $list->getIdVenta(); ?>" type="button" data-toggle="tooltip" title="Ver listado de Detalle"  class="btn docs-tooltip btn-danger btn-xs"><i class="fa fa-eye"></i></a>
