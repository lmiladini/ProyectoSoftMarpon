<?php
error_reporting(0);
require "../Modelo/TipoMateria.php";
?>
<?php
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tbody>
                                <?php
                                $arrTipoMateria =TipoMateria::getAll();
                                foreach ($arrTipoMateria as $List){
                                    ?>
                                    <tr>

                                        <td><?php echo $List->getNombre(); ?></td>
                                        <td><?php echo $List->getCantidad(); ?></td>
                                        <td><?php echo $List->getValor(); ?></td>
                                        <td><?php echo $List->getUMedida(); ?></td>




                                        <td>
                                            <a href="editarTipoMateria.php?id=<?php echo $List->getIdTipoMateria(); ?>" type="button" data-toggle="tooltip" title="Actualizar" class="btn docs-tooltip btn-primary btn-xs"><i class="fa fa-edit"></i></a>
