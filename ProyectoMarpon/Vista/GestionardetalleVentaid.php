            ...
            <div class="row">
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        <?php
                        $pro = VentaController::buscarID($_GET["id"]);
                        ...
                        <div class="panel-body">
                            <div class="adv-table editable-table ">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <?php
                                    $id=$_GET["id"];
                                    $arrDetalle = Detalle ::getAll();
                                    foreach ($arrDetalle  as $list){
                                    if($list->getVenta()==$id){
                                        ?>
                                        <tr>
                                            ...
                                            <?php
                                            $id = $list->getProducto();
                                            $b = ProductoController::buscarID($id);
                                            $nombre1 = $b->getNombre();
                                            ?>
                                            ...
                                            <td>
                                                <a href="EditarDetalle.php?id=<?php echo $list->getIdDetalle(); ?>" type="button" data-toggle="tooltip" title="Actualizar" class="btn docs-tooltip btn-primary btn-xs"><i class="fa fa-edit"></i></a>
