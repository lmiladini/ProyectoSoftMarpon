                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    foreach ($arrIngresos  as $list){
                                        ...
                                        <tr>
                                            ...
                                            $id = $list->getProveedor();
                                            $a = ProveedorCtrl::buscarID($id);
                                            $nombre = $a->getRazonSocial();
                                            ?>
                                            <td><?php echo $nombre ?></td>
                                            ...
                                            <td>
                                                <a href="editarIngresos.php?id=<?php echo $list->getIdIngresos(); ?>" type="button" data-toggle="tooltip" title="Actualizar" class="btn docs-tooltip btn-primary btn-xs"><i class="fa fa-edit"></i></a>
