                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                foreach ($arrCliente as $ReCli){
                                    ?>
                                    <tr>
                                        <td><?php echo $ReCli->getTipoDocumento(); ?></td>
                                        <td><?php echo $ReCli->getDocumento(); ?></td>
                                        <td><?php echo $ReCli->getNombre(); ?></td>
                                        <td><?php echo $ReCli->getApellido(); ?></td>
                                        <td><?php echo $ReCli->getTelefono(); ?></td>
                                        <td><?php echo $ReCli->getEmail(); ?></td>
                                        <td><?php echo $ReCli->getDireccion(); ?></td>
                                        <td><?php echo $ReCli->getCiudad(); ?></td>


                                        <td>
                                            <a href="editarCliente.php?id=<?php echo $ReCli->getIdClientes(); ?>" type="button" data-toggle="tooltip" title="Actualizar" class="btn docs-tooltip btn-primary btn-xs"><i class="fa fa-edit"></i></a>
