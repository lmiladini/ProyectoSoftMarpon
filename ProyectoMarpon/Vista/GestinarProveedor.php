                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                foreach ($arrayProveedor as $Regrecep){
                                    ?>
                                    <tr>
                                        <td><?php echo $Regrecep->getRazonSocial(); ?></td>
                                        <td><?php echo $Regrecep->getNitRut(); ?></td>
                                        <td><?php echo $Regrecep->getCiudad(); ?></td>
                                        <td><?php echo $Regrecep->getDireccion(); ?></td>
                                        <td><?php echo $Regrecep->getTelefono(); ?></td>
                                        <td><?php echo $Regrecep->getContrato(); ?></td>


                                        <td>
                                            <a href="editarProveedor.php?id=<?php echo $Regrecep->getIdProveedor(); ?>" type="button" data-toggle="tooltip" title="Actualizar" class="btn docs-tooltip btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
